    ...
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-12">
      <div className="bg-white border-b border-gray-200 py-6 px-4 mb-6 shadow-sm">
        <div className="container mx-auto">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Your Cart ({cartCount})</h1>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-4">
            {items.map((item) => (
              <div key={item.slug} className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm flex flex-col sm:flex-row gap-4">
                {/* Product Image */}
                ...
                <div className="flex-1 flex flex-col justify-between">
                  ...
                  <div className="flex items-end justify-between mt-2">
                    ...
                    <div className="text-right">
                      <span className="block font-bold text-gray-900 text-lg">${item.price * item.quantity}</span>
                      {item.quantity > 1 && (
                        <span className="text-xs text-gray-500">${item.price} / item</span>
                      )}
                    </div>
                  </div>
                </div>
