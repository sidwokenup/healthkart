...
import { MapPin, Phone, Mail, User, ShieldCheck, ArrowRight, Loader2 } from "lucide-react";
...
export default function CheckoutPage() {
  ...
  const fillAddress = (address: any, source: "GPS" | "IP") => {
    ...
    if (address.city || address.town || address.village || address.county) {
        newFormData.city = address.city || address.town || address.village || address.county || "";
    }
  ...
  const handlePlaceOrder = async () => {
    // Basic Validation
    if (!formData.name || !formData.phone || !formData.address1 || !formData.city || !formData.state || !formData.zip) {
    ...
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-12">
      ...
      <div className="bg-white border-b border-gray-200 py-6 px-4 shadow-sm mb-6">
        <div className="container mx-auto">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">Delivery Details</h1>
          <p className="text-gray-500 text-sm">We will contact you to confirm your order</p>
        </div>
      </div>
          ...
          <div className="flex-1 space-y-6">
            ...
            <section className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                <User size={20} className="mr-2 text-primary" /> Contact Information
              </h2>
            ...
            <section className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2">
                <h2 className="text-lg font-bold text-gray-900 flex items-center">
                  <MapPin size={20} className="mr-2 text-primary" /> Delivery Address
                </h2>
                <button 
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  {formData.state === "Other" && (
                     <div className="animate-in fade-in slide-in-from-top-2 duration-200">
                       <label htmlFor="customState" className="block text-sm font-medium text-gray-700 mb-1">Enter State Manually</label>
                       <input 
                         type="text" 
                         id="customState"
          ...
          <div className="lg:w-96">
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm sticky top-24">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 mb-4 flex items-start">
                <ShieldCheck size={18} className="text-primary mt-0.5 mr-2 flex-shrink-0" />
                <p className="text-xs text-blue-800">
                  No online payment required. Our team will call you to confirm details before delivery.
                </p>
              </div>
